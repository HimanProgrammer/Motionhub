/* PromptMotion — prompt catalog (master-prompt format, PLAIN CSS — no Tailwind).
   Loaded as a global so the site works with no build step.
   These seed the database via the admin "Seed starter prompts" button.
   Asset URLs below are real, verified free-stock links (Pexels video, Unsplash/Picsum images). */
