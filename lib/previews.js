...
export const PREVIEWS = {
  ...
  "checkmate-chess-dashboard": "https://images.unsplash.com/photo-1528819622765-d6bcf132f793?w=1600&q=80",
  "propertix-property-management": "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=1600&q=80",
};
...
/* Every template has a real, self-contained live demo page under /public/demos
   (see scripts/gen-demos.js) — this is what "Preview" opens: the actual running
   website, not just a static thumbnail. */
export function getDemoUrl(p) {
  return p && p.id ? `/demos/${p.id}.html` : "";
}
